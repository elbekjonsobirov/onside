...
export default function Interview() {
  ...
  useEffect(() => {
    const interNewsFunc = async () => {
      const sportNewsItem = await axios.get('https://onside-sport.uz/api/news/byType?type=INTERVIEW&page=1&limit=25')
  ...
  return (
    <div className="swTortPage">
      <div className="swTortTitleCard">
      ...
      >
        {interNewsAll.map((item, index) => (
          ...
          >
            ...
            ></div>
            <div className="swTortAboutCard">
              <h1 className="swTortTitle">
            {item.text.length > 80 ? `${item.text.slice(0, 60)}...` : item.text}
              </h1>
              <div className="swTortLikeCard">
                <div className="swTortLike">
                  <span>
                    <svg
                      width="12"
                      height="13"
              ...
              <div className="swTortTimeCard">
                <div className="swTortTime">
                  <span>
                    <svg
                      width="15"
                      height="16"
