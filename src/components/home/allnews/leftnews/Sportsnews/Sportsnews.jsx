...
export default function Sportsnews() {
  ...
  const [sportNewsAll, setSportNewsAll] = useState([])

  useEffect(() => {
    const sportNewsFunc = async () => {
      const sportNewsItem = await axios.get('http://185.196.213.14:3001/news/byType?type=SPORT&page=1&limit=25')
  ...
  return (
    <div className="swUchPage">
      <div className="swUchTitleCard">
        <h1 className="swUchTitle">SPORT YANGILIKLARI</h1>
      ...
      <div className="swUchNews">
        {sportNewsAll.map((item, index) => (
          <div onClick={() => {
            ...
            ></div>
            <div className="swUchAboutCard">
              <h1 className="swUchTitle">
                {item.text.length > 80 ? `${item.text.slice(0, 60)}...` : item.text}
              </h1>
              <div className="swUchLikeCard">
                <div className="swUchLike">
                  <span>
                    <svg
                      width="12"
                      height="13"
                ...
                <div className="swUchSport">
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <circle cx="3" cy="3" r="3" fill="#3FF1D2" />
                  </svg>
                  <span>{item.categoryId}</span>
                </div>
              </div>
              <div className="items-lines"></div>
              <div className="swUchTimeCard">
                <div className="swUchTime">
                  <span>
                    <svg
                      width="15"
                      height="16"
