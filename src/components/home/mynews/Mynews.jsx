...
import myNewsImg from "../../Imgs/news-image.jpg";
import "./Mynews.css";
...
export default function Mynews() {
  ...
  const newLocal = `2022 yilgi Qatar jahon chempionatiga kafolat bergan davlatlar`;
  const [myNewsImgCardText] = useState([
    {
      title: newLocal,
      data: "28.10.2022",
      time: "21:45",
    ...
    {
      title: `2022 yilgi Qatar jahon chempionatiga kafolat bergan davlatlar`,
      data: "28.10.2022",
      time: "21:45",
      like: "1796",
      comment: "385",
  ...
  return (
    <div className="myNewsPage">
      <div className="myNewsTitleCard">
        <h1 className="myNewsTitle">Mening YANGILIKlarim</h1>
        <div className="myNewsFilCard">
          <select
          ...
          >
            ...
            <option className="yangMenuItem" value="">
              Three
            </option>
            <option className="yangMenuItem" value="">
              Four
      ...
      <Swiper
        ...
        className="mySwiper"
      >
        {myNewsImgCardText.map((item, index) => (
          <SwiperSlide
            key={index}
            onClick={() => {
              navigate(`/xabarlar/todos/${index + 1}`);
            }}
          >
            <div className="myNewsItemUrl">
              <div className="myNewsImgCard">
                <div
                  className="myNewsBgimg"
                  style={{ backgroundImage: `url(${myNewsImg})` }}
                ></div>
                <p className="myNewsImgCardText">
                  {test.length > 80 ? `${test.slice(0, 80)}...` : test}
                </p>
              </div>
              <div className="myNewsAboutCard">
                <div className="myNewsAboutCardTime">
                  <span>
                    <svg
                      width="15"
                      height="16"
                ...
                <div className="myNewsAboutCardLike">
                  <span>
                    <svg
                      width="12"
                      height="13"
                ...
                <div className="myNewsAboutCardComment">
                  <span>
                    <svg
                      width="10"
                      height="10"
